...
cpx_touch_pixel_rainbow.py is saved as code.py which runs when the board is rebooted.  The board reboots every time you write to it.

Edit that file and see what happens!


Have some more handy URLs
docs:
